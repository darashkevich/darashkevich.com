...
echo ""
echo "Icons: hosted HTTPS (required for Gmail recipients)."
echo "Mail preview: Settings > Privacy — disable 'Protect Mail Activity' or allow remote images."
echo "Mail-only local preview: re-run with --base64-icons (breaks Gmail for sent mail)."
echo ""
